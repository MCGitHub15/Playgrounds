...
struct CodeSyntax {
    enum QueryNodeType: String, Codable, CaseIterable {
        case forInStmt
...
struct Hint: Codable {
    ...
    var id: String
    var condition = Condition.onMatch
    
    init(_ condition: Condition, _ id: String) {
...
extension [Hint] {
    static func onMatch(_ id: String) -> [Hint] {
        [Hint(.onMatch, id)]
    }
}
...
extension CodeSyntaxQueryModifier {
    ...
    func functionCall(_ name: String? = nil, matching namePattern: String? = nil, containingText textContentPattern: String? = nil, arguments: [Argument] = [], id: String? = nil, hints: [Hint]? = nil) -> FunctionCall where Self: ChainableExpressionQuery, Self: CodeSyntaxQueryNode {
        var newQueryNode = FunctionCall(name, matching: namePattern, containingText: textContentPattern, arguments: arguments, id: id, hints: hints)
        newQueryNode.parentExpressionQuery = CodeSyntaxQueryNodeWrapper(self)
        return newQueryNode
    }
    
    func member(_ name: String? = nil, matching namePattern: String? = nil, containingText textContentPattern: String? = nil, id: String? = nil, hints: [Hint]? = nil) -> Member where Self: ChainableExpressionQuery, Self: CodeSyntaxQueryNode {
        var newQueryNode = Member(name, matching: namePattern, id: id, hints: hints)
        newQueryNode.parentExpressionQuery = CodeSyntaxQueryNodeWrapper(self)
        return newQueryNode
    }
}
...
extension CodeSyntaxQueryNode {
    ...
    var description: String {
        ...
        if let id {
            desc += " '\(id)'"
        } else if let firstHint = hints?.first {
            desc += " hint: '\(firstHint.id)'"
        }
        return desc
    }
}
...
struct Function: CodeSyntaxDeclarationQuery {
    ...
    init(_ name: String? = nil, matching namePattern: String? = nil, containingText textContentPattern: String? = nil, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode] = { [] }) {
...
struct Variable: CodeSyntaxDeclarationQuery {
    ...
    var namePattern: String?
    var textContentPattern: String?
    var simpleType: CodeSyntax.SimpleType?
    var maxDepth: Int? = 1
    var wrappedChildren: [CodeSyntaxQueryNodeWrapper] = []
    
    var initializerQuery: CodeSyntaxQueryNodeWrapper?

    init(_ name: String? = nil, matching namePattern: String? = nil, containingText textContentPattern: String? = nil, ofType simpleType: CodeSyntax.SimpleType? = nil, initialValue: CodeSyntaxExpressionQuery? = nil, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode] = { [] }) {
        setNamePattern(name, namePattern)
        self.textContentPattern = textContentPattern
...
struct Identifier: CodeSyntaxExpressionQuery, QueryableByName, FilterableByDepth, ChainableExpressionQuery {
    ...
    init(_ name: String? = nil, matching namePattern: String? = nil, id: String? = nil, hints: [Hint]? = nil) {
        setNamePattern(name, namePattern)
        self.id = id
        self.hints = hints
    }
...
struct Literal: CodeSyntaxExpressionQuery {
    ...
    init(_ value: Bool, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(_ value: Int, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(inRange range: Range<Int>, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(inRange range: ClosedRange<Int>, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(_ value: Double, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(inRange range: Range<Double>, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(inRange range: ClosedRange<Double>, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(_ value: String, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(_ literalType: CodeSyntax.LiteralType, matching valuePattern: String? = nil, id: String? = nil, hints: [Hint]? = nil) {
...
struct BinaryOperator: CodeSyntaxExpressionQuery {
    ...
    init(_ token: String, id: String? = nil, hints: [Hint]? = nil) {
        self.token = token
        self.id = id
        self.hints = hints
    }
...
struct SequenceExpr: CodeSyntaxExpressionQuery {
    ...
    init(id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxExpressionQueryBuilder _ expressions: () -> [CodeSyntaxExpressionQuery]) {
        self.id = id
        self.hints = hints
...
struct RangeExpr: CodeSyntaxExpressionQuery {
    ...
    init(_ range: Range<Int>, id: String? = nil, hints: [Hint]? = nil) {
    ...
    init(_ range: ClosedRange<Int>, id: String? = nil, hints: [Hint]? = nil) {
        self.wrappedExpressions = SequenceExpr( {
            Literal(range.lowerBound)
            BinaryOperator("...")
            Literal(range.upperBound) }).wrappedExpressions
    ...
    init(_ lowerBound: CodeSyntaxExpressionQuery, _ op: String, _ upperBound: CodeSyntaxExpressionQuery, id: String? = nil, hints: [Hint]? = nil) {
        self.wrappedExpressions = SequenceExpr( {
                lowerBound
                BinaryOperator(op)
...
struct Argument: Codable, QueryableByName {
    var namePattern: String?
    ...
    init(_ name: String? = nil, matching namePattern: String? = nil, _ expression: CodeSyntaxExpressionQuery) {
        wrappedExpression = CodeSyntaxQueryNodeWrapper(expression)
        setNamePattern(name, namePattern)
    }
...
struct FunctionCall: CodeSyntaxExpressionQuery, ChainableExpressionQuery, QueryableByName, QueryableByTextContent, QueryableHasChildren, FilterableByDepth {
    ...
    init(_ name: String? = nil, matching namePattern: String? = nil, containingText textContentPattern: String? = nil, arguments: [Argument] = [], id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode] = { [] }) {
        setNamePattern(name, namePattern)
        self.textContentPattern = textContentPattern
...
extension FunctionCall: CodeSyntaxQueryModifier {
    ...
    func modifier(_ name: String? = nil, matching namePattern: String? = nil, containingText textContentPattern: String? = nil, arguments: [Argument] = [], id: String? = nil, hints: [Hint]? = nil) -> FunctionCall {
        var newQueryNode = FunctionCall(name, matching: namePattern, containingText: textContentPattern, arguments: arguments, id: id, hints: hints)
        newQueryNode.parentExpressionQuery = CodeSyntaxQueryNodeWrapper(self)
        return newQueryNode
    }
...
struct If: CodeSyntaxStatementQuery {
    ...
    init(id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxExpressionQueryBuilder _ conditions: () -> [CodeSyntaxExpressionQuery], @CodeSyntaxQueryBuilder body: () -> [CodeSyntaxQueryNode], @CodeSyntaxQueryBuilder elseBody: () -> [CodeSyntaxQueryNode] = { [] }) {
        self.id = id
        self.hints = hints
    ...
    init(_ condition: CodeSyntaxExpressionQuery, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder body: () -> [CodeSyntaxQueryNode], @CodeSyntaxQueryBuilder elseBody: () -> [CodeSyntaxQueryNode] = { [] }) {
        self.id = id
        self.hints = hints
...
struct ForIn: CodeSyntaxStatementQuery, QueryableByTextContent, QueryableHasChildren {
    ...
    init(item: String? = nil, itemMatching itemPattern: String? = nil, containingText textContentPattern: String? = nil, collection: CodeSyntaxExpressionQuery? = nil, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode] = { [] }) {
        if let item {
...
struct CodeSyntaxQuery: CodeSyntaxQueryNode, QueryableHasChildren {
    ...
    init(id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode]) {
        self.id = id
        self.hints = hints
        self.wrappedChildren = content().map { CodeSyntaxQueryNodeWrapper($0) }
    }
...
struct AllOf: CodeSyntaxQuantifierQuery {
    ...
    init(_ option: CodeSyntax.AllOfOption = .anyOrder, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode]) {
        self.option = option
        self.id = id
        self.hints = hints
        self.wrappedChildren = content().map { CodeSyntaxQueryNodeWrapper($0) }
...
struct CountOf: CodeSyntaxQuantifierQuery {
    ...
    var range: Range<Int>
// TODO: rdar://103019653 (Nautilus: CountOf query should support a ClosedRange as well as Range)
//    var closedRange: ClosedRange<Int>
    
    var mustBeContiguous = false

    init(_ range: Range<Int>, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode]) {
        self.range = range
        self.id = id
        self.hints = hints
        self.wrappedChildren = content().map { CodeSyntaxQueryNodeWrapper($0) }
    ...
    init(_ count: Int, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode]) {
    ...
    init(contiguous range: Range<Int>, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode]) {
        self.range = range
        self.id = id
        self.hints = hints
        self.wrappedChildren = content().map { CodeSyntaxQueryNodeWrapper($0) }
    ...
    init(contiguous count: Int, id: String? = nil, hints: [Hint]? = nil, @CodeSyntaxQueryBuilder content: () -> [CodeSyntaxQueryNode]) {
        self.range = count..<(count + 1)
        self.id = id
        self.hints = hints
        self.wrappedChildren = content().map { CodeSyntaxQueryNodeWrapper($0) }
